...
GLKObject* GLKObList::GetHead() { if (!headPos) return nullptr; return headPos->data; }
...
void GLKArray::Add(void* data)
{
	...
	{
		//std::cout << "the size are equal!!!" << std::endl;
		arraySize=arraySize+step;
		//void** newlist=(void**)new long[arraySize];
		void** newlist = new void*[arraySize];
		int n=size;
